...
set_max_delay 5.88 -from [ get_clocks { Video_Pipeline_0/Camera_subsys_1/IMX334_IF_TOP_0/PF_CCC_C2_0/PF_CCC_C2_0/pll_inst_0/OUT0 } ] -to [ get_clocks {CLOCKS_AND_RESETS_inst_0/PF_CCC_170MCLK_0/PF_CCC_170MCLK_0/pll_inst_0/OUT0} ]

# CDC between HDMI and VID 170MHZ clocks
set_max_delay 5.88 -from [ get_clocks {Video_Pipeline_0/HDMI_subsys_1/PF_XCVR_ERM_C2_0/I_XCVR/LANE0/RX_CLK_R} ] -to [ get_clocks {CLOCKS_AND_RESETS_inst_0/PF_CCC_170MCLK_0/PF_CCC_170MCLK_0/pll_inst_0/OUT0} ]
set_max_delay 5.88 -from [ get_clocks {Video_Pipeline_0/HDMI_subsys_1/PF_XCVR_ERM_C2_0/I_XCVR/LANE1/RX_CLK_R} ] -to [ get_clocks {CLOCKS_AND_RESETS_inst_0/PF_CCC_170MCLK_0/PF_CCC_170MCLK_0/pll_inst_0/OUT0} ]
set_max_delay 5.88 -from [ get_clocks {Video_Pipeline_0/HDMI_subsys_1/PF_XCVR_ERM_C2_0/I_XCVR/LANE2/RX_CLK_R} ] -to [ get_clocks {CLOCKS_AND_RESETS_inst_0/PF_CCC_170MCLK_0/PF_CCC_170MCLK_0/pll_inst_0/OUT0} ]
set_max_delay 5.88 -from [ get_clocks {Video_Pipeline_0/HDMI_subsys_1/PF_XCVR_ERM_C2_0/I_XCVR/LANE3/RX_CLK_R} ] -to [ get_clocks {CLOCKS_AND_RESETS_inst_0/PF_CCC_170MCLK_0/PF_CCC_170MCLK_0/pll_inst_0/OUT0} ]

# CDC between VID 170MHZ and Display clocks
set_max_delay 6.7 -from [ get_clocks {CLOCKS_AND_RESETS_inst_0/PF_CCC_170MCLK_0/PF_CCC_170MCLK_0/pll_inst_0/OUT0} ] -to [ get_clocks { Video_Pipeline_0/HDMI_subsys_1/PF_XCVR_ERM_C2_0/I_XCVR/LANE1/TX_CLK_R } ]
set_max_delay 6.7 -from [ get_clocks { Video_Pipeline_0/HDMI_subsys_1/PF_XCVR_ERM_C2_0/I_XCVR/LANE1/TX_CLK_R } ] -to [ get_clocks {CLOCKS_AND_RESETS_inst_0/PF_CCC_170MCLK_0/PF_CCC_170MCLK_0/pll_inst_0/OUT0} ]
