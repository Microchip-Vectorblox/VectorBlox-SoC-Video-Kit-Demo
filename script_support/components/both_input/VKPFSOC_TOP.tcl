...
# Add DDR_AXI4_INTERCONNECT_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {DDR_AXI4_INTERCONNECT} -instance_name {DDR_AXI4_INTERCONNECT_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_150MHz" "Video_Pipeline_0:CLK_150MHz" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_50MHz" "MSS:FIC_3_PCLK" "PF_DDR4_C0_0:PLL_REF_CLK" "Video_Pipeline_0:CLK_50MHz" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_HLS" "DDR_AXI4_INTERCONNECT_0:CLK_HLS" "FIC0_INITIATOR:S_CLK3" "FIC0_INITIATOR:S_CLK4" "FIC0_INITIATOR:S_CLK5" "axi_master_scale_updown_bilinear_top_0:clk" "axi_master_warpPerspective_top_0:clk" "draw_assist_0:clk" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_MSS" "DDR_AXI4_INTERCONNECT_0:CLK_MSS" "FIC0_INITIATOR:ACLK" "MSS:FIC_0_ACLK" "MSS:FIC_1_ACLK" "pulse_generator_0:pulse_clk" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_VBX" "DDR_AXI4_INTERCONNECT_0:CLK_VBX" "FIC0_INITIATOR:S_CLK2" "core_vectorblox_C0_0:clk" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_VBX_2X" "core_vectorblox_C0_0:clk_2x" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_VBX_CNN" "core_vectorblox_C0_0:clk_cnn" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_VID_TX_170MHZ" "Video_Pipeline_0:VID_TX_CLK_170MHZ" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_XCVR_REF" "Video_Pipeline_0:REF_CLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:DDR_CTRLR_READY" "PF_DDR4_C0_0:CTRLR_READY" "Video_Pipeline_0:CTRLR_READY" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:DDR_PLL_LOCK" "PF_DDR4_C0_0:PLL_LOCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:DDR_SYS_CLK" "DDR_AXI4_INTERCONNECT_0:CLK_DDR" "PF_DDR4_C0_0:SYS_CLK" "Video_Pipeline_0:CLK_DDR" "axi_arbiter_0:clk" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:DEVICE_INIT_DONE" "Video_Pipeline_0:INIT_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:DISP_CLK" "Video_Pipeline_0:DISP_CLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_50MHz" "PF_DDR4_C0_0:SYS_RESET_N" "Video_Pipeline_0:RESETN_50MHz" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_DDR" "Video_Pipeline_0:RESETN_DDR" "axi_arbiter_0:resetn" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_DISP" "Video_Pipeline_0:RESETN_DISP" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_MSS" "DDR_AXI4_INTERCONNECT_0:RESETN_MSS" "FIC0_INITIATOR:ARESETN" "VSC_8662_RESETN" "pulse_generator_0:resetn" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_VBX" "DDR_AXI4_INTERCONNECT_0:RESETN_DDR" "DDR_AXI4_INTERCONNECT_0:RESETN_VBX" "core_vectorblox_C0_0:resetn" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_VID170MHZ" "Video_Pipeline_0:RESETN_VID170MHZ" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_HPD_N_I" "Video_Pipeline_0:HPD_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_HPD_O" "Video_Pipeline_0:HPD_O" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_SCL_I" "Video_Pipeline_0:SCL_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_SDA" "Video_Pipeline_0:SDA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_WE_N" "PF_DDR4_C0_0:WE_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE0_RXD_N" "Video_Pipeline_0:LANE0_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE0_RXD_P" "Video_Pipeline_0:LANE0_RXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE0_TXD_N" "Video_Pipeline_0:LANE0_TXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE0_TXD_P" "Video_Pipeline_0:LANE0_TXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE1_RXD_N" "Video_Pipeline_0:LANE1_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE1_RXD_P" "Video_Pipeline_0:LANE1_RXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE1_TXD_N" "Video_Pipeline_0:LANE1_TXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE1_TXD_P" "Video_Pipeline_0:LANE1_TXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE2_RXD_N" "Video_Pipeline_0:LANE2_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE2_RXD_P" "Video_Pipeline_0:LANE2_RXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE2_TXD_N" "Video_Pipeline_0:LANE2_TXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE2_TXD_P" "Video_Pipeline_0:LANE2_TXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE3_RXD_N" "Video_Pipeline_0:LANE3_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE3_RXD_P" "Video_Pipeline_0:LANE3_RXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE3_TXD_N" "Video_Pipeline_0:LANE3_TXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE3_TXD_P" "Video_Pipeline_0:LANE3_TXD_P" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MSS:GPIO_2_M2F_7" "Video_Pipeline_0:IMX334_TRNG_RST_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_INTERCONNECT_0:AXI4mslave0" "axi_arbiter_0:be" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_INTERCONNECT_0:HLS_draw_assist_AXI4M" "draw_assist_0:m_axi" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_INTERCONNECT_0:HLS_scale_updown_bilinear_AXI4M" "axi_master_scale_updown_bilinear_top_0:master" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_INTERCONNECT_0:HLS_warpPerspective_AXI4M" "axi_master_warpPerspective_top_0:master" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_INTERCONNECT_0:MSS_FIC_1_AXI4M" "MSS:FIC_1_AXI4_INITIATOR" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_INTERCONNECT_0:Video_Pipeline_scaler_AXI4M" "Video_Pipeline_0:AXI4M_scaler" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_INTERCONNECT_0:core_vectorblox_M0_AXIM" "core_vectorblox_C0_0:M0_AXI" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_INTERCONNECT_0:core_vectorblox_M1_AXIM" "core_vectorblox_C0_0:M1_AXI" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:APBmslave" "Video_Pipeline_0:APB_IF" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Video_Pipeline_0:ARBITER_MSLAVE_AXI4" "axi_arbiter_0:rt" }
