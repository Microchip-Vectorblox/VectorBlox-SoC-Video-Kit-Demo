...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_150MHz" "HDMI_subsys_1:RX_EDID_CLK_I" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Camera_subsys_1:CAM_CLK" "video_cdc_fifo_cam:tclk" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Camera_subsys_1:CAM_DATA_VALID_O" "video_cdc_fifo_cam:target_data_valid_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Camera_subsys_1:CAM_EOF_O" "video_cdc_fifo_cam:target_frame_sync_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Camera_subsys_1:CAM_RESET_N" "video_cdc_fifo_cam:tresetn" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Camera_subsys_1:IMX334_ARST_N" "HDMI_subsys_1:RX_RESET_N" "INIT_DONE" "synchronizer_circuit_0:reset_n" "video_cdc_fifo_hdmi:tresetn" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_0_BIBUF_0:E" "HDMI_subsys_1:RX_SDA_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_0_BIBUF_0:PAD" "SDA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_0_BIBUF_0:Y" "HDMI_subsys_1:RX_SDA_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:DATA_VALID_I" "video_out_subsys_1:DATA_ENABLE_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:HPD_I" "synchronizer_circuit_0:sync_out" "video_switch_0:sel_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:H_SYNC_I" "video_out_subsys_1:H_SYNC_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE0_RXD_N" "LANE0_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE0_RXD_P" "LANE0_RXD_P" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE1_RXD_N" "LANE1_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE1_RXD_P" "LANE1_RXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE1_RX_CLK_R" "video_cdc_fifo_hdmi:tclk" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE2_RXD_N" "LANE2_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE2_RXD_P" "LANE2_RXD_P" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE3_RXD_N" "LANE3_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE3_RXD_P" "LANE3_RXD_P" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_DATA_VALID_O" "video_cdc_fifo_hdmi:target_data_valid_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_HPD_O" "HPD_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_SCL_I" "SCL_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_V_SYNC_O" "video_cdc_fifo_hdmi:target_frame_sync_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESETN_VID170MHZ" "video_cdc_fifo_cam:iresetn" "video_cdc_fifo_hdmi:iresetn" "video_input_subsys_0:vid_in_resetn" "video_switch_0:resetn" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"VID_TX_CLK_170MHZ" "frame_controller_0:vid_in_clk_i" "synchronizer_circuit_0:sys_clk" "video_cdc_fifo_cam:iclk" "video_cdc_fifo_hdmi:iclk" "video_input_subsys_0:vid_in_clk" "video_switch_0:clk" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"apb3_if_0:frame_end_i" "frame_controller_0:vid_in_frame_sync_i" "video_input_subsys_0:vid_in_frame_sync" "video_switch_0:frame_sync_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"video_input_subsys_0:vid_data_valid_i" "video_switch_0:data_valid_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Camera_subsys_1:CAM_BLUE_O" "video_cdc_fifo_cam:target_data_i[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Camera_subsys_1:CAM_GREEN_O" "video_cdc_fifo_cam:target_data_i[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Camera_subsys_1:CAM_RED_O" "video_cdc_fifo_cam:target_data_i[23:16]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_B_O" "video_cdc_fifo_hdmi:target_data_i[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_G_O" "video_cdc_fifo_hdmi:target_data_i[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_R_O" "video_cdc_fifo_hdmi:target_data_i[23:16]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"video_input_subsys_0:vid_data_i" "video_switch_0:data_o" }
