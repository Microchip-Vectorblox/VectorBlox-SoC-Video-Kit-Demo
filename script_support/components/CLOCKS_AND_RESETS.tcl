...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_1:A" "AND4_0:Y" "CORERESET_CLK_DDR:PLL_LOCK" "CORERESET_CLK_DISP:PLL_LOCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_1:B" "AND3_0:Y" "CORERESET_CLK_50MHz:PLL_LOCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_1:Y" "CORERESET_CLK_HLS:PLL_LOCK" "CORERESET_CLK_MSS:PLL_LOCK" "CORERESET_CLK_VBX_0:PLL_LOCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:A" "AND4_0:D" "PF_CCC_VBX_0:PLL_LOCK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:B" "AND4_0:C" "PF_CCC_MAIN:PLL_LOCK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:C" "CORERESET_CLK_50MHz:INIT_DONE" "CORERESET_CLK_DDR:INIT_DONE" "CORERESET_CLK_DISP:INIT_DONE" "CORERESET_CLK_HLS:INIT_DONE" "CORERESET_CLK_MSS:INIT_DONE" "CORERESET_CLK_VBX_0:INIT_DONE" "DEVICE_INIT_DONE" "INIT_MONITOR_0:DEVICE_INIT_DONE" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_50MHz:EXT_RST_N" "CORERESET_CLK_DDR:EXT_RST_N" "CORERESET_CLK_DISP:EXT_RST_N" "CORERESET_CLK_HLS:EXT_RST_N" "CORERESET_CLK_MSS:EXT_RST_N" "CORERESET_CLK_VBX_0:EXT_RST_N" "EXT_RST_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_50MHz:FABRIC_RESET_N" "RESETN_50MHz" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_50MHz:FPGA_POR_N" "CORERESET_CLK_DDR:FPGA_POR_N" "CORERESET_CLK_DISP:FPGA_POR_N" "CORERESET_CLK_HLS:FPGA_POR_N" "CORERESET_CLK_MSS:FPGA_POR_N" "CORERESET_CLK_VBX_0:FPGA_POR_N" "FABRIC_POR_N" "INIT_MONITOR_0:FABRIC_POR_N" }
