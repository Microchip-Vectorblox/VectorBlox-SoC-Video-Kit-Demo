...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:A" "DDR_read_controller_HDMI_RX_0:reset_i" "data_unpacker_HDMI_RX_0:reset_i" "reset_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:sys_clk_i" "sys_clk_i" "video_fifo_0:wclock_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"bayer_dvalid_o" "data_unpacker_HDMI_RX_0:data_valid_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_HDMI_RX_0:disp_clk_i" "disp_clk_i" "video_fifo_0:rclock_i" }
