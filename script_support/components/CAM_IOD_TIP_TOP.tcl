...
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {IOD_MIPI_TRAINING} -hdl_file {hdl\IOD_MIPI_TRAINING.V} -instance_name {CORERXIODBITALIGN_C0_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C0_0:BIT_TRNG_FAIL}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C0_0:WINDOW_START_INDEX}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C0_0:WINDOW_END_INDEX}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C0_0:WINDOW_SET_INDEX}



# Add CORERXIODBITALIGN_C1_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {IOD_MIPI_TRAINING} -hdl_file {hdl\IOD_MIPI_TRAINING.V} -instance_name {CORERXIODBITALIGN_C1_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C1_0:BIT_TRNG_FAIL}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C1_0:WINDOW_START_INDEX}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C1_0:WINDOW_END_INDEX}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C1_0:WINDOW_SET_INDEX}



# Add CORERXIODBITALIGN_C2_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {IOD_MIPI_TRAINING} -hdl_file {hdl\IOD_MIPI_TRAINING.V} -instance_name {CORERXIODBITALIGN_C2_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:BIT_TRNG_FAIL}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:WINDOW_START_INDEX}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:WINDOW_END_INDEX}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:WINDOW_SET_INDEX}



# Add CORERXIODBITALIGN_C3_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {IOD_MIPI_TRAINING} -hdl_file {hdl\IOD_MIPI_TRAINING.V} -instance_name {CORERXIODBITALIGN_C3_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:BIT_TRNG_FAIL}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:WINDOW_START_INDEX}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:WINDOW_END_INDEX}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:WINDOW_SET_INDEX}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:A" "CORERXIODBITALIGN_C0_0:BIT_TRNG_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:B" "CORERXIODBITALIGN_C1_0:BIT_TRNG_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:C" "CORERXIODBITALIGN_C2_0:BIT_TRNG_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:D" "CORERXIODBITALIGN_C3_0:BIT_TRNG_DONE" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:BIT_ALGN_CLR_FLG" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[0:0]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:RESTART_TRNG" "CORERXIODBITALIGN_C1_0:RESTART_TRNG" "CORERXIODBITALIGN_C2_0:RESTART_TRNG" "CORERXIODBITALIGN_C3_0:RESTART_TRNG" "RESTART_TRNG" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:SKIP_TRNG" "CORERXIODBITALIGN_C1_0:SKIP_TRNG" "CORERXIODBITALIGN_C2_0:SKIP_TRNG" "CORERXIODBITALIGN_C3_0:SKIP_TRNG" "SKIP_TRNG" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:BIT_ALGN_CLR_FLG" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[1:1]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:BIT_ALGN_CLR_FLG" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[2:2]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:BIT_ALGN_CLR_FLG" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[3:3]" }
