...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {apb3_if_0:INTENSITY_SUM_I} -value {GND}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_50MHz" "apb3_if_0:pclk_i" "frame_controller_0:pclk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:HPD_I" "HPD_I" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:LANE1_RX_CLK_R" "frame_controller_0:vid_in_clk_i" "video_input_subsys_0:vid_in_clk" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_DATA_VALID_O" "video_input_subsys_0:vid_data_valid_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_HPD_O" "HPD_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_RESET_N" "INIT_DONE" "video_input_subsys_0:vid_in_resetn" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_SCL_I" "SCL_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_V_SYNC_O" "apb3_if_0:frame_end_i" "frame_controller_0:vid_in_frame_sync_i" "video_input_subsys_0:vid_in_frame_sync" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESETN_50MHz" "apb3_if_0:preset_i" "frame_controller_0:resetn_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_B_O" "video_input_subsys_0:vid_data_i[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_G_O" "video_input_subsys_0:vid_data_i[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI_subsys_1:RX_R_O" "video_input_subsys_0:vid_data_i[23:16]" }
