...
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CLOCKS_AND_RESETS:CLK_VID_TX_170MHZ}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CLOCKS_AND_RESETS:RESETN_VID170MHZ}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_DDR" "DDR_AXI4_INTERCONNECT_0:RESETN_DDR" "Video_Pipeline_0:RESETN_DDR" "axi_arbiter_0:resetn" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_VBX" "DDR_AXI4_INTERCONNECT_0:RESETN_VBX" "core_vectorblox_C0_0:resetn" }
