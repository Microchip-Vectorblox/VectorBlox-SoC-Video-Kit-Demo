...
sd_create_bus_port -sd_name ${sd_name} -port_name {rdata_0} -port_direction {IN} -port_range {[511:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {arlen_0} -port_direction {OUT} -port_range {[15:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {awlen_0} -port_direction {OUT} -port_range {[15:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {wdata_0} -port_direction {OUT} -port_range {[511:0]}
sd_create_bus_port -sd_name ${sd_name} -port_name {wstrb_0} -port_direction {OUT} -port_range {[63:0]}
