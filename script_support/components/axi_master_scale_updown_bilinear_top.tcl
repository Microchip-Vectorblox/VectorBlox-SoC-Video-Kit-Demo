# Exporting core axi_master_scale_updown_bilinear_top to TCL
# Exporting Create HDL core command for module axi_master_scale_updown_bilinear_top
create_hdl_core -file {hdl/scale.v} -module {axi_master_scale_updown_bilinear_top} -library {work} -package {}
# Exporting BIF information of  HDL core command for module axi_master_scale_updown_bilinear_top
hdl_core_add_bif -hdl_core_name {axi_master_scale_updown_bilinear_top} -bif_definition {AXI4:AMBA:AMBA4:slave} -bif_name {axi_s} -signal_map {\
...
hdl_core_add_bif -hdl_core_name {axi_master_scale_updown_bilinear_top} -bif_definition {AXI4:AMBA:AMBA4:master} -bif_name {master} -signal_map {\
