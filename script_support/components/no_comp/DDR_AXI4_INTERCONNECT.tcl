...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_DDR" "COREAXI4INTERCONNECT_C0_0:ACLK" "COREAXI4INTERCONNECT_C0_0:M_CLK5" "COREAXI4INTERCONNECT_C0_0:S_CLK0" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_VBX" "COREAXI4INTERCONNECT_C0_0:M_CLK1" "COREAXI4INTERCONNECT_C0_0:M_CLK6" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREAXI4INTERCONNECT_C0_0:ARESETN" "RESETN_DDR" }
